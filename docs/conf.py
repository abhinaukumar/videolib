...
extensions = [
    ...
    'sphinx.ext.linkcode',  # Add an external link to the Python source code for classes, functions etc.
...
def linkcode_resolve(domain, info):
    ...
    filename = f'https://github.com/abhinaukumar/videolib/blob/main/{filename}.py'
    return filename